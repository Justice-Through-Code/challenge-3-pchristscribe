...
def stock_purchases():
    ...
    number_of_stocks = investment_amount // individual_stocks[stock_name]    
    ...
    print(f'{name} has ${investment_amount} to invest and can buy {number_of_stocks} shares of {stock_name} at the current price of ${individual_stocks[stock_name] }.')
stock_purchases()