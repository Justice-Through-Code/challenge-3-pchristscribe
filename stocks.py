...
def stock_purchases():
    ...
    number_of_stocks = investment_amount // stocks    
    ...
    print(f'{name} has ${investment_amount} to invest and can buy {number_of_stocks} shares of {stock_name} at the current price of ${stocks}.')
# stock_purchases()